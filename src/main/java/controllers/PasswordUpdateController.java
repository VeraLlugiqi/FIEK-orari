...
public class PasswordUpdateController extends SceneController {
    ...
    private void saveChanges() {
        ...
        // Update the password using the PasswordUpdateService
        PasswordUpdateService passwordUpdateService = new PasswordUpdateService();
        boolean success = passwordUpdateService.updatePassword(user.getIdNumber(), currentPassword, newPassword, confirmPassword);
    ...
    public void updateTexts() {
        // Retrieve translations from the ResourceBundle based on the selected language code
        //ResourceBundle bundle = Translate.getBundle(selectedLanguageCode);


        profileTextLabel.setText(userRepository.getTranslation("profileTextLabel.text"));
        profileLabel.setText(userRepository.getTranslation("profileLabel.text"));
        repeatPasswordLabel.setText(userRepository.getTranslation("repeatPasswordLabel.text"));
        newPasswordLabel.setText(userRepository.getTranslation("newPasswordLabel.text"));
        passwordLabel.setText(userRepository.getTranslation("passwordLabel.text"));
        saveChangesButton.setText(userRepository.getTranslation("saveChangesButton.text"));
        startButton.setText(userRepository.getTranslation("startButton.text"));
        manageClassButton.setText(userRepository.getTranslation("manageClassButton.text"));
        profileButton.setText(userRepository.getTranslation("profileButton.text"));
        Oraributton.setText(userRepository.getTranslation("Oraributton.text"));
        NdihmaButton.setText(userRepository.getTranslation("NdihmaButton.text"));
        logoutButton.setText(userRepository.getTranslation("logoutButton.text"));
    }
